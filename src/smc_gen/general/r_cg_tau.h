...
#define _0600_TAU_TRIGGER_MASTER_INT_TI03 (0x0600U)    /* interrupt signal of the master is used as start trigger,
                                                       a valid edge of the TI03 pin is used as the end trigger */
...
/* Operation mode of channel n (MDmn3 - MDmn1) */
...
#define _0008_TAU_MODE_TWOCHAN_MASTER     (0x0008U)    /* two-channel input with one-shot pulse output (master) */
#define _0004_TAU_MODE_TWOCHAN_SLAVE      (0x0004U)    /* two-channel input with one-shot pulse output (slave) */
/* Setting of starting counting and interrupt (MDmn0) */
/* For interval timer mode, capture mode*/
...
#define _0000_TAU_START_INT_UNUSED        (0x0000U)    /* interrupt is not generated when counting is started */
/* For one-count mode */
#define _0000_TAU_START_TRIGGER_INVALID   (0x0000U)    /* start trigger is invalid during counting operation */
#define _0001_TAU_START_TRIGGER_VALID     (0x0001U)    /* start trigger is valid during counting operation */
/* For capture and one-count mode */
#define _0000_TAU_TRIGGER_INT_UNUSED      (0x0000U)    /* interrupt is not generated when counting is started 
...
*/
/* Selection of timer input used with channel 5 of unit 0 (TIS02 - TIS00) */
...
#define _00_TAU_CH1_INPUT_TI01            (0x00U)    /* input signal of TI01 pin is used as timer input */
#define _02_TAU_CH1_INPUT_RXD0            (0x02U)    /* input signal of RxD0 pin is used as timer input */
#define _FD_TAU_CH1_INPUT_CLEAR           (0xFDU)    /* channel 1 input clear */
/* External interrupt (INTP0) input switching (ISC0) */
#define _00_EXTERNAL_INPUT_INTP0          (0x00U)    /* input signal of INTP0 is used as external interrupt input */
#define _01_EXTERNAL_INPUT_RXD0           (0x01U)    /* input signal of RxD0 pin is used as external interrupt input */
