...
/* Pin count
 ...
 B = 32-pin  : 0x5
*/
#define BSP_CFG_MCU_PART_PIN_NUM (0x4)
...
#define BSP_CFG_OPTBYTE2_VALUE (0xE0U)
#define BSP_CFG_OPTBYTE3_VALUE (0x04U)
...
*/
#define BSP_CFG_SUBCLK_SOURCE (1)
...
*/
#define BSP_CFG_RTC_OUT_CLK_SOURCE (1)
